# wybierany zawsze szybszy algorytm
import time
...
def all_unique(word, strategia):
    return strategia(word)
...
def main():
    ...
    while True:
        ...
        while not word:
            ...
            if len(word) < LIMIT:
                strategia = all_unique_sort
            else:
                strategia = all_unique_set

            result = all_unique(word, strategia)
